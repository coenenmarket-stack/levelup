  ...
  if (enLoc?.id) {
    ...
    try {
      ...
      if (fs.existsSync(path.join(dir65, "01-hero.png"))) {
        ...
        push("6.5 screenshots skipped — generate with script/generate-app-store-screenshots.ts first");
      }
    } catch (e) {
